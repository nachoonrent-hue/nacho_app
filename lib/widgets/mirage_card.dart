                  ...
                  ClipRRect(
                    ...
                    child: Image.network(
                      ...
                      errorBuilder: (context, error, stackTrace) => Container(
                        ...
                        child: const Icon(Icons.explore, color: AppColors.primaryPlum, size: 48),
                      ),
                    ),
                  ),
                  Positioned(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const Icon(Icons.timer_outlined, size: 12, color: AppColors.secondaryText),
                        const SizedBox(width: 2),
                        Text(experience.duration, style: const TextStyle(fontSize: 11, color: AppColors.secondaryText)),
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            const Icon(Icons.star_rounded, color: AppColors.saffron, size: 14),
                            const SizedBox(width: 2),
                            Text('${experience.rating}', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                          ],
                        ),
                        RichText(
                          text: TextSpan(
