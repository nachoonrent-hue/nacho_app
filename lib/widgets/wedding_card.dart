...
/// Shared hero tag linking the card cover to the event detail header.
String weddingEventCoverTag(String eventId) => 'event-cover-$eventId';
              ...
              child: Column(
                ...
                children: [
                  Stack(
                    children: [
                      Hero(
                        tag: weddingEventCoverTag(event.id),
                        child: ClipRRect(
